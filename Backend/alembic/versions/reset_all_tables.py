...
# 10 пользователей (3 gov + 7 citizen)
    op.bulk_insert(
        users_t,
        [
            {"id": 1,  "iin": "000000000001", "phone": "+77011110001", "name": "Алихан Смаилов",   "email": "gov1@example.com",     "hashed_password": admin_pwd, "role": "government", "region_id": 2,  "is_active": True},
            {"id": 2,  "iin": "000000000002", "phone": "+77011110002", "name": "Нурлан Абенов",    "email": "gov2@example.com",     "hashed_password": admin_pwd, "role": "government", "region_id": 3,  "is_active": True},
            {"id": 3,  "iin": "000000000003", "phone": "+77011110003", "name": "Мадина Касымова",  "email": "gov3@example.com",     "hashed_password": admin_pwd, "role": "government", "region_id": 5,  "is_active": True},
            {"id": 4,  "iin": "000000000004", "phone": "+77011110004", "name": "Айгерим Бекова",   "email": "citizen1@example.com", "hashed_password": demo_pwd,  "role": "citizen",    "region_id": 1,  "is_active": True},
            {"id": 5,  "iin": "000000000005", "phone": "+77011110005", "name": "Дана Сейткали",    "email": "citizen2@example.com", "hashed_password": demo_pwd,  "role": "citizen",    "region_id": 4,  "is_active": True},
            {"id": 6,  "iin": "000000000006", "phone": "+77011110006", "name": "Бауыржан Ержанов", "email": "citizen3@example.com", "hashed_password": demo_pwd,  "role": "citizen",    "region_id": 2,  "is_active": True},
            {"id": 7,  "iin": "000000000007", "phone": "+77011110007", "name": "Салтанат Омарова", "email": "citizen4@example.com", "hashed_password": demo_pwd,  "role": "citizen",    "region_id": 8,  "is_active": True},
            {"id": 8,  "iin": "000000000008", "phone": "+77011110008", "name": "Ерлан Досымов",    "email": "citizen5@example.com", "hashed_password": demo_pwd,  "role": "citizen",    "region_id": 11, "is_active": True},
            {"id": 9,  "iin": "000000000009", "phone": "+77011110009", "name": "Жанар Ахметова",   "email": "citizen6@example.com", "hashed_password": demo_pwd,  "role": "citizen",    "region_id": 16, "is_active": True},
            {"id": 10, "iin": "000000000010", "phone": "+77011110010", "name": "Тимур Касенов",    "email": "citizen7@example.com", "hashed_password": demo_pwd,  "role": "citizen",    "region_id": 7,  "is_active": True},
        ],
    )
...
# 43 варианта ответа
    op.bulk_insert(
        ...
        [
            ...
            # Q2 — какими услугами пользовались
...
# Q16 — безопасность
    ...
    op.bulk_insert(
        ...
        [
            # Survey 1 — госуслуги
            {"id": 1,  "user_id": 4,  "survey_id": 1, "question_id": 1,  "option_id": 2,    "text_answer": None},
            {"id": 2,  "user_id": 4,  "survey_id": 1, "question_id": 2,  "option_id": 5,    "text_answer": None},
            {"id": 3,  "user_id": 4,  "survey_id": 1, "question_id": 3,  "option_id": None, "text_answer": "Нужно сократить время ожидания."},
            {"id": 4,  "user_id": 6,  "survey_id": 1, "question_id": 1,  "option_id": 3,    "text_answer": None},
            {"id": 5,  "user_id": 6,  "survey_id": 1, "question_id": 2,  "option_id": 6,    "text_answer": None},
            {"id": 6,  "user_id": 6,  "survey_id": 1, "question_id": 3,  "option_id": None, "text_answer": "Хотелось бы больше онлайн-услуг."},
            # Survey 2 — дороги
            {"id": 7,  "user_id": 4,  "survey_id": 2, "question_id": 4,  "option_id": 11,   "text_answer": None},
            {"id": 8,  "user_id": 4,  "survey_id": 2, "question_id": 5,  "option_id": 12,   "text_answer": None},
            {"id": 9,  "user_id": 4,  "survey_id": 2, "question_id": 6,  "option_id": None, "text_answer": "На главных улицах много ям."},
            {"id": 10, "user_id": 5,  "survey_id": 2, "question_id": 4,  "option_id": 10,   "text_answer": None},
            {"id": 11, "user_id": 5,  "survey_id": 2, "question_id": 5,  "option_id": 13,   "text_answer": None},
            {"id": 12, "user_id": 5,  "survey_id": 2, "question_id": 6,  "option_id": None, "text_answer": "Нет тротуаров в моём районе."},
            # Survey 3 — экология
            {"id": 13, "user_id": 6,  "survey_id": 3, "question_id": 7,  "option_id": 17,   "text_answer": None},
            {"id": 14, "user_id": 6,  "survey_id": 3, "question_id": 8,  "option_id": 19,   "text_answer": None},
            {"id": 15, "user_id": 6,  "survey_id": 3, "question_id": 9,  "option_id": None, "text_answer": "Воздух стал хуже за последние годы."},
            {"id": 16, "user_id": 7,  "survey_id": 3, "question_id": 7,  "option_id": 18,   "text_answer": None},
            {"id": 17, "user_id": 7,  "survey_id": 3, "question_id": 8,  "option_id": 21,   "text_answer": None},
            {"id": 18, "user_id": 7,  "survey_id": 3, "question_id": 9,  "option_id": None, "text_answer": "Слишком много мусора во дворах."},
            # Survey 4 — медицина
            {"id": 19, "user_id": 4,  "survey_id": 4, "question_id": 10, "option_id": 24,   "text_answer": None},
            {"id": 20, "user_id": 4,  "survey_id": 4, "question_id": 11, "option_id": 27,   "text_answer": None},
            {"id": 21, "user_id": 4,  "survey_id": 4, "question_id": 12, "option_id": None, "text_answer": "Нужно больше специалистов в поликлиниках."},
            {"id": 22, "user_id": 5,  "survey_id": 4, "question_id": 10, "option_id": 25,   "text_answer": None},
            {"id": 23, "user_id": 5,  "survey_id": 4, "question_id": 11, "option_id": 29,   "text_answer": None},
            {"id": 24, "user_id": 5,  "survey_id": 4, "question_id": 12, "option_id": None, "text_answer": "Очереди очень длинные."},
            # Survey 5 — образование
            {"id": 25, "user_id": 8,  "survey_id": 5, "question_id": 13, "option_id": 31,   "text_answer": None},
            {"id": 26, "user_id": 8,  "survey_id": 5, "question_id": 14, "option_id": 34,   "text_answer": None},
            {"id": 27, "user_id": 8,  "survey_id": 5, "question_id": 15, "option_id": None, "text_answer": "Нужно обновить компьютеры в школах."},
            {"id": 28, "user_id": 9,  "survey_id": 5, "question_id": 13, "option_id": 32,   "text_answer": None},
            {"id": 29, "user_id": 9,  "survey_id": 5, "question_id": 14, "option_id": 33,   "text_answer": None},
            {"id": 30, "user_id": 9,  "survey_id": 5, "question_id": 15, "option_id": None, "text_answer": "Учителям нужно повысить зарплату."},
            # Survey 6 — безопасность
            {"id": 31, "user_id": 6,  "survey_id": 6, "question_id": 16, "option_id": 38,   "text_answer": None},
            {"id": 32, "user_id": 6,  "survey_id": 6, "question_id": 17, "option_id": 40,   "text_answer": None},
            {"id": 33, "user_id": 6,  "survey_id": 6, "question_id": 18, "option_id": None, "text_answer": "Много краж в нашем районе."},
            {"id": 34, "user_id": 10, "survey_id": 6, "question_id": 16, "option_id": 37,   "text_answer": None},
            {"id": 35, "user_id": 10, "survey_id": 6, "question_id": 17, "option_id": 42,   "text_answer": None},
            {"id": 36, "user_id": 10, "survey_id": 6, "question_id": 18, "option_id": None, "text_answer": "Тёмные улицы создают угрозу."},
        ],
    )
