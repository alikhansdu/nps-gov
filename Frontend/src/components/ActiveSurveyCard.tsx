...
export default function ActiveSurveyCard({
  ...
  return (
    <div className="bg-white border border-[#E4E4E7] rounded-xl overflow-hidden flex flex-col shadow-sm w-full">
      {/* Header */}
      ...
      {/* Divider */}
      <div style={{ height: "1px", backgroundColor: "#E4E4E7", margin: "0 20px" }} />

      {/* Meta */}
      <div className="px-5 pt-3 pb-3 flex flex-col gap-2">
      ...
      <div className="px-5 pb-5">
        <Link
          to={`/surveys/${id}`}
          className="w-full py-3 text-sm font-medium rounded-lg transition-colors text-center block"
