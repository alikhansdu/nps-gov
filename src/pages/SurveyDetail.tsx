...
const survey = {
  ...
  description: "Оцените текущее состояние и предложите меры по улучшению городского транспорта в вашем регионе. Ваш голос напрямую влияет на приоритеты государственной инфраструктурной политики.",
  initiator: "Министерство индустрии и инфраструктурного развития РК",
  deadline: "До 15 марта 2026",
  participants: "142 850",
  question: "Какой приоритет развития транспорта наиболее важен для вашего города?",
  options: [
    "Расширение маршрутной сети автобусов",
    "Строительство новых линий метро / LRT",
    "Улучшение состояния дорог и тротуаров",
    "Развитие велосипедной инфраструктуры",
    "Цифровизация транспорта (умные остановки, приложения)",
  ],
};
      ...
      <main className="flex-1 w-full max-w-7xl mx-auto flex flex-col gap-5"
        ...
        {!voted ? (
          <div className="bg-white border border-gray-200 rounded-xl p-6 flex flex-col gap-5">
            <h2 className="text-lg font-semibold text-gray-900">{survey.question}</h2>
            ...
            <div className="flex flex-col gap-3">
              {survey.options.map((opt, i) => (
                <button
                  ...
                  style={{
                    borderColor: selected === i ? "#0A1628" : "#E5E7EB",
            ...
            <button
              ...
              style={{
                backgroundColor: selected !== null ? "#0A1628" : "#9CA3AF",
                color: "white",
